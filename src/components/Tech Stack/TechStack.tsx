    ...
    return (
        <>
            ...
            <span className='techStackHeading'>Tech Stack</span>
                    ...
                    <TechStackItem icon='https://img.icons8.com/color/48/000000/html-5.png' title='HTML' text='HTML wird für die zur Strukturierung von Inhalten in Webseiten verwendet, um Text, Medien und andere Ressourcen zu definieren und zu organisieren.'/>
